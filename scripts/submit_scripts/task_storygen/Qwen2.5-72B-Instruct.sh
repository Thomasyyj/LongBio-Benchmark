MODEL_PATH="/cpfs01/shared/XNLP_H800/zeyuhuang/models/Qwen2.5-72B-Instruct"
...
tokenizer_model="Qwen2.5-7B-Instruct"
...
for context_length in "${context_lengths[@]}"; do
    batch_size=$((32*${n_gpu}/${context_length}))
    e_batch_size=$((32/${batch_size}))
